// function Validator(formSelector, options) { //c1
...
//this nằm ở ngoài này nó sẽ nàm trực tiếp trong contructor function Validator nên từ khóaa this này tchinhs là đối tượng đc khởi tạo 
// khi gọi từ khóa new nó sẽ khởi tạo ra một đối tượng với contructor function Validatorthì từ khóa this trong 
// contructor function đó sẽ tương úng với đối tượng mà nó tạo ra 
// nó sẽ in ra Validator{} nó chính là đối tượng đươch khởi tạo từ  contructor Validator và Validator{}  tương ứng với thằng form
// từ khóa thí nằm trong một contructor function thì nó sed tưongw đương với cái đối tượng đc tạo ra từ contructor function đó    
console.log(this)
        ...
        // at Validator.formElement.onsubmit lỗi này có nghĩa là onSubmit ko phải là một hàm
            ...
            //    nó sẽ gọi onsubmit ở bên ngoài 
...
var a={
    ...
    console.log(Array.isArray(a['amen']))
    console.log(a)
...
//return values[input.name]=input.value  &&values xem ở dưới ta thấy nếu mà input.value (lấy giá trị từ input) mà chuỗi rỗng
// thì nó sẽ là chuỗi rỗng nằm trong 6 thằng còn mà có value là long thì tả về long 

console.log(a['linh']='')

console.log(a['linh']='long')